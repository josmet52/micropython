...
#         now = my_rtc.rtc_now()  # get date and time
        ...
        txt ='HW-390 soil sensor: soil_1 humidity abs =' + ' %3.2f' %soil_moist_abs_volt + ' humidity rel =' + ' %3.2f%%' %soil_moist_rel_val + '\n'
        msg += txt
        
        # HW-390 soil sensor 2
        soil_humid_abs_volt = my_HW390_soil_2.get_voltage()
#         soil_moist_rel_val = (soil_humid_abs_volt - HW390_000) / HW390_PENTE
        soil_moist_rel_val = (soil_humid_abs_volt - HW390_000) / (HW390_100 - HW390_000) * 100
        txt ='HW-390 soil sensor: soil_2 humidity abs =' + ' %3.2f' %soil_moist_abs_volt + ' humidity rel =' + ' %3.2f%%' %soil_moist_rel_val + '\n'
        msg += txt
